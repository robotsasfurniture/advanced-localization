...
class ConventionalSrp(XSrp):
    ...
    def __init__(self, fs: float, grid_type, n_grid_cells,
        ...
        available_modes = ["gcc_phat_freq", "gcc_phat_time", "gcc_phat_beta", "cross_correlation"]
    ...
    def compute_signal_features(self, mic_signals):
        ...
        elif self.mode == "gcc_phat_beta":
            return gcc_phat(mic_signals, abs=True, return_lags=False, ifft=True, beta=0.65)
